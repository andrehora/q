...
Quais representam exemplos de manutenção adaptativa?:
...
Qual prática de manutenção consiste em alterar a estrutura interna do código sem modificar seu comportamento externo?:
- Engenharia reversa.
- Reengenharia.
- Refatoração. x
- Teste de regressão.

Sobre refatoração, assinale as alternativas corretas:
